...
copy /Y .\explorer\w10.exe C:\Windows\explorer.exe
...
copy /Y .\start\w10.exe C:\Windows\SystemApps\Microsoft.Windows.StartMenuExperienceHost_cw5n1h2txyewy\StartMenuExperienceHost.exe
